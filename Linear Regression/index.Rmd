...
<img class=center src="assets/img/whatdatascience.png" height = 400px width=400px />
...
```{r echo=FALSE}
# The aim is for these trainings to be interactice, we are also learning and will 
...
head(mydata, row.names = False)
#plot(x = mydata$X, y = mydata$Y, main = "X ~ Y")
```
...
#library(ggplot2)
#plot(cars$speed ~ cars$dist, main = "Dist ~ Speed")
#lines(x=seq(0,100), y=seq(0,100))
```
...
<img src="assets/img/residuals.png" height=300px />
